...
(async () => {
	...
	for (const filePath in files) {
		...
		let getFile;
		try {
			const response = await axios.get(`https://github.com/N1SA9EDITZ/KuRuMiV3/raw/main/${filePath}`, {
	...
	const { data: packageHTML } = await axios.get("https://github.com/N1SA9EDITZ/KuRuMiV3/blob/main/package.json");
