const { KuRuMiV3Apis } = global.utils;
...
module.exports = {
	...
	langs: {
		vi: {
			...
			missingGoatApiKey: "❗ Chưa cài đặt apikey cho KuRuMiV3, vui lòng truy cập goatbot.tk để lấy apikey và cài đặt vào file configCommands.json > envGlobal.goatbotApikey và lưu lại"
		},
		en: {
			syntaxError: "⚠️ Please enter prompt",
			error: "❗ An error has occurred, please try again later:\n%1",
			serverError: "❗ Server is overloaded, please try again later",
			missingGoatApiKey: "❗ Not set apikey for KuRuMiV3, please visit goatbot.tk to get apikey and set it to configCommands.json > envGlobal.goatbotApikey and save"
		}
	},

	onStart: async function ({ message, args, getLang, envGlobal }) {
		const goatBotApi = new KuRuMiV3Apis(envGlobal.goatbotApikey);
