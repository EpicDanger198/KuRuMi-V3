module.exports = {
  ...
  return true;
    ...
    const GODPermission = global.KuRuMiV3.config.GOD;
const vipUserPermission = global.KuRuMiV3.config.vipUser;
const adminBotPermission = global.KuRuMiV3.config.adminBot;
