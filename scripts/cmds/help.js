...
const { commands, aliases } = global.KuRuMiV3;
...
module.exports = {
  ...
  onStart: async function ({ message, args, event, threadsData, role }) {
    ...
    if (args.length === 0) {
      ...
      msg += toFancyFont(`\n\n╭────────────➣\n\n𝙸 𝙷𝙰𝚅𝙴  ${totalCommands} 𝙲𝙼𝙳𝚂\n𝚃𝚈𝙿𝙴 ☞︎︎︎${prefix} 𝙷𝙴𝙻𝙿 𝚃𝙾 𝚅𝙸𝙴𝚆 𝚇𝟹 𝙰𝙻𝙻 𝙲𝙼𝙳\n𝙰𝙽𝙳 𝙻𝙴𝙰𝚁𝙽 𝙷𝙾𝚆 𝚃𝙾 𝚄𝚂𝙴 𝚇3 𝙲𝙼𝙳\n➪☁︎╰──────────────➣`);
      msg += toFancyFont(`\n╭──────────────➣\n𝚇𝟹 𝙱𝙾𝚃 𝙲𝚁𝙴𝙰𝚃𝙾𝚁 ☞︎︎︎—͟͞͞ɴiនꫝɴ✘Ꭼᴅɪᴛᴢ ⸙ ❄︎\n
╰──────────────➣`);
...
function roleTextToString(roleText) {
  switch (roleText) {
    ...
    case 2:
      ...
      case 3:
      return toFancyFont("3 (Deploper user)");
      case 4:
      return toFancyFont("4 (Premium user)");
    default:
