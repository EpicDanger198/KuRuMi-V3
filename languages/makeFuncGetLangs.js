...
let pathLanguageFile = `${__dirname}/${global.KuRuMiV3.config.language}.lang`;
if (!fs.existsSync(pathLanguageFile)) {
	log.warn("LANGUAGE", `Can't find language file ${global.KuRuMiV3.config.language}.lang, using default language file "${__dirname}/en.lang"`);
