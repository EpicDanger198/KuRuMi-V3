  ...
  switch (data.__typename) {
    ...
    case "GenericAdminTextMessage":
      switch (data.extensible_message_admin_text_type) {
        ...
        default:
          throw new Error(
            `Unknown admin text type: "${data.extensible_message_admin_text_type}", if this happens to you let me know when it happens. Please open an issue at https://github.com/N1SA9EDITZ/fb-chat-api/issues.`
          );
      }
    case "UserMessage":
      return {
    ...
    default:
      throw new Error(
        `Unknown message type: "${data.__typename}", if this happens to you let me know when it happens. Please open an issue at https://github.com/N1SA9EDITZ/fb-chat-api/issues.`
      );
    // If this happens to you let me know when it happens
    // Please open an issue at https://github.com/N1SA9EDITZ/fb-chat-api/issues.
